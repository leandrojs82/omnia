...
<p align="center"><strong>Canivete suíço digital</strong> — 26 ferramentas em um único arquivo HTML.<br>
...
| **Data e Hora** | Contar dias entre datas · Idade exata · Dias úteis · Pomodoro com sons |
...
Aparece o placar (hoje **76/76**). Os testes cobrem a lógica pura de cada ferramenta — os dígitos verificadores de CPF e CNPJ são conferidos contra 200 documentos gerados por execução, e a idade exata é validada por um teste de propriedade com 500 pares de datas aleatórias. A suíte fica verde também com o `localStorage` bloqueado.
